var graduates = [
    {
        year: 2017,
        data: [
            { name: 'Abdelrahman Aymen', image: '' },
            { name: 'Abdelrahman El-Ansasy', image: '' },
            { name: 'Abdelrahman Gad', image: '' },
            { name: 'Abdelrahman Mady', image: '' },
            { name: 'Abdelrahman Orief', image: '' },
            { name: 'Abdelrahman Refaat', image: '' },
            { name: 'Adham Medhat', image: '' },
            { name: 'Adham Shady', image: '' },
            { name: 'Ahmed Abdelsattar', image: '' },
            { name: 'Ahmed Hossam', image: '' },
            { name: 'Ahmed Hossam', image: '' },
            { name: 'Ahmed Tarfa', image: '' },
            { name: 'George Wagih', image: '' },
            { name: 'Hamdy Adel', image: '' },
            { name: 'Hana Ghanem', image: '' },
            { name: 'Hany Hamza', image: '' },
            { name: 'Ibrahim Yosry', image: '' },
            { name: 'Jumana Wanass', image: '' },
            { name: 'Karim Ashraf', image: '' },
            { name: 'Karim Mohamed', image: '' },
            { name: 'Mahmoud Beshr', image: '' },
            { name: 'Marawan Mohamed', image: '' },
            { name: 'Maya Tamer', image: '' },
            { name: 'Melody Tamer', image: '' },
            { name: 'Mohab Wafaie', image: '' },
            { name: 'Mohamed Hanafi', image: '' },
            { name: 'Mohamed Ramadan', image: '' },
            { name: 'Mohannad Mohammed', image: '' },
            { name: 'Mostafa Magdy', image: '' },
            { name: 'Nour Mahmoud', image: '' },
            { name: 'Omar Ahmed', image: '' },
            { name: 'Omar Samir', image: '' },
            { name: 'Ragai Ahmed', image: '' },
            { name: 'Rahma Magdy', image: '' },
            { name: 'Rawan Kasem', image: '' },
            { name: 'Retag Tarek', image: '' },
            { name: 'Shahd Mahmoud', image: '' },
            { name: 'Wafik Wael', image: '' },
            { name: 'Waled Mostafa', image: '' },
            { name: 'Yosra Mohamed', image: '' },
            { name: 'Youssef Ahmed', image: '' },
            { name: 'Yusuf El-Nady', image: '' },
            { name: 'Ziyad Eslam', image: '' }
        ]
    },
    {
        year: 2016,
